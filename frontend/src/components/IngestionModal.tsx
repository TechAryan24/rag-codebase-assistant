...
import { X, Terminal, CheckCircle2, Loader2, ArrowRight } from 'lucide-react';
          ...
          {!isProcessing ? (
            ...
            <div className="flex flex-col justify-center items-center flex-1 space-y-6">
              <div className="text-center space-y-2">
                 <h3 className="text-lg font-medium text-white">Ingest Codebase</h3>
                 <p className="text-gray-400">Enter the local path to your repository</p>
              </div>
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="flex-1 space-y-2 mb-6 overflow-hidden">
                {logs.map((log, idx) => (
                   <div key={idx} className="flex items-center gap-3 text-gray-300 animate-in fade-in slide-in-from-left-4 duration-300">
